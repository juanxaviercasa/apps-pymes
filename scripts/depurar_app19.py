...
for path in [ROOT / 'html/generador-politicas-terminos.html', ROOT / 'html/generador-politicas-terminos.html']:
...
for path in [ROOT / 'js/generador-politicas-terminos.js']:
    text = path.read_text(encoding='utf-8', errors='replace')
