...
html_files = [
    ROOT / 'apps/simulador-tco-fisico-nube.html',
    ROOT / 'simulador-tco-fisico-nube/index.html',
]
...
bundle_files = [
    ROOT / 'apps/js/simulador-tco-fisico-nube.js',
    ROOT / 'simulador-tco-fisico-nube/assets/index.js',
]
